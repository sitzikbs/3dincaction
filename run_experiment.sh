...
python3 test_action_pred.py --dataset_path $DATASET_PATH --pc_model $MODEL --frames_per_clip $N_FRAMES --batch_size $BATCH_SIZE --shuffle_points $POINTS_SHUFFLE --n_points $N_POINTS --model '000030.pt' --model_path $LOGDIR --set $SET --visualize_results 0
