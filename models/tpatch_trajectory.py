...
class tPatchTraj(nn.Module):
    def __init__(self, model_cfg, num_class, n_frames=32, in_channel=3):
        ...
        self.patchlet_temporal_conv2 = PatchletTemporalConv(in_channel=128+in_channel+128, temporal_conv=3,
                                                            mlp=[128, 128, 256],
                                                            use_attn=use_attn, attn_num_heads=attn_num_heads)
        ...
        self.patchlet_temporal_conv3 = PatchletTemporalConv(in_channel=256+in_channel+128, temporal_conv=3,
                                                            mlp=[256, 512, 1024],
                                                            use_attn=use_attn, attn_num_heads=attn_num_heads)
