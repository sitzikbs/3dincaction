...
parser.add_argument('--steps_per_update', type=int, default=40, help='number of steps per backprop update')
...
parser.add_argument('--logdir', type=str, default='./log/3dmfv_scale/', help='path to model save dir')
...
def run(init_lr=0.001, max_steps=64e3, frames_per_clip=16, dataset_path='/home/sitzikbs/Datasets/dfaust/',
    ...
    train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=batch_size, num_workers=8, pin_memory=True)
