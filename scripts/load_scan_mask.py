...
def parse_masks(path):
    with h5py.File(path, 'r') as f:
        ...
        print('%d out of %d vertices (%.2f%%) in the sequence are accurately registered' % (n_gt_verts, n_verts, perc))
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description='Parse ground-truth masks for scan sequence')
    parser.add_argument('--path', type=str, default='../masks',
