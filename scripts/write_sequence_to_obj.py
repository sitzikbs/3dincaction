...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='/mnt/3.5TB_WD/Datasets/dfaust/registrations_f.hdf5',
                        help='dataset path in hdf5 format')
    parser.add_argument('--seq', type=str, default='jiggle_on_toes', help='sequence name')
    parser.add_argument('--sid', type=str, default='50004', choices=sids,
                        help='subject id')
    parser.add_argument('--tdir', type=str, default='/mnt/3.5TB_WD/Datasets/dfaust/objs/', help='target directory')
